...
public class MovieControllerTest {
    ...
    public void shouldCreateMovie() throws Exception {
        ...
        MockHttpServletRequestBuilder request = post("/movies")
                ...
                .content("{\"title\": \"airlift\"}");

        this.mvc.perform(request)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is(3)))
                .andExpect(jsonPath("$.title", is("airlift")));
    }
    ...
    public void shouldFindAllMovies() throws Exception {
        Movie m1 = new Movie();
        m1.setTitle("Finding Nemo");
        Movie m2 = new Movie();
        m2.setTitle("Finding Dory");
    ...
    public void shouldFindMovieByTitle() throws Exception {
        given(this.service.findByTitle("airlift"))
                .willReturn(movie);

        MockHttpServletRequestBuilder request = get("/movies/search?title=airlift");
    ...
    public void shouldDeleteMovieByID() throws Exception {
        MockHttpServletRequestBuilder request = delete("/movies/3");
        this.mvc.perform(request)
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(content().string(is("")));
    ...
    @Test
    public void shouldNotDeleteMovieWhenIDDoesNotExist () throws Exception {
        MockHttpServletRequestBuilder request = delete("/movies/77");
    ...
    public void shouldUpdateMovie() throws Exception {
        ...
        MockHttpServletRequestBuilder request = put("/movies/1")
                .contentType(MediaType.APPLICATION_JSON)
                .content("{\"title\": \"airlift\"}");
